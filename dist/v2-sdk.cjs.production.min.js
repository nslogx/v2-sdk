...
function A(t) {
  ...
  return (A = function(t) {
    ...
    function n() {
      return T(t, arguments, d(this).constructor)
    }
    return (
...
function g(t, e) {
  ...
  if ('undefined' == typeof Symbol || null == t[Symbol.iterator]) {
    if (
      ...
      (n = (function(t, e) {
        if (t) {
          if ('string' == typeof t) return k(t, void 0)
...
var w = 'setPrototypeOf' in Object,
  I = (function(t) {
    function e() {
      ...
      return (
        ...
        w && Object.setPrototypeOf(q(n), (this instanceof e ? this.constructor : void 0).prototype),
        n
      )
    }
    return m(e, t), e
  ...
  O = function(t) {
    var e = t.factoryAddress,
      ...
      r = t.tokenB,
      i = t.initCodeHash,
      s = n.sortsBefore(r) ? [n, r] : [r, n]
    return u.getCreate2Address(
      e,
      o.keccak256(['bytes'], [o.pack(['address', 'address'], [s[0].address, s[1].address])]),
      i
    )
  },
  b = (function() {
    function t(e, r, o, u) {
      var i = e.currency.sortsBefore(r.currency) ? [e, r] : [r, e]
      ;(this.factoryAddress = o),
        (this.initCodeHash = u),
        (this.liquidityToken = new n.Token(
          i[0].currency.chainId,
          t.getAddress(i[0].currency, i[1].currency, o, u),
          18,
          'UNI-V2',
          'Uniswap V2'
        )),
    ...
    return (
      ...
      (o.getOutputAmount = function(o) {
        ...
        var u = this.reserveOf(o.currency),
          ...
          a = e.multiply(o.quotient, p),
          c = e.multiply(a, i.quotient),
          h = e.add(e.multiply(u.quotient, l), a),
          f = n.CurrencyAmount.fromRawAmount(o.currency.equals(this.token0) ? this.token1 : this.token0, e.divide(c, h))
        if (e.equal(f.quotient, s)) throw new x()
        return [f, new t(u.add(o), i.subtract(f), this.factoryAddress, this.initCodeHash)]
      }),
      (o.getInputAmount = function(o) {
        if (
          (this.involvesToken(o.currency) || r(!1),
        ...
        var u = this.reserveOf(o.currency),
          i = this.reserveOf(o.currency.equals(this.token0) ? this.token1 : this.token0),
          c = e.multiply(e.multiply(i.quotient, o.quotient), l),
          h = e.multiply(e.subtract(u.quotient, o.quotient), p),
          f = n.CurrencyAmount.fromRawAmount(
            o.currency.equals(this.token0) ? this.token1 : this.token0,
            e.add(e.divide(c, h), a)
          )
        return [f, new t(i.add(f), u.subtract(o), this.factoryAddress, this.initCodeHash)]
      }),
      (o.getLiquidityMinted = function(t, o, u) {
        t.currency.equals(this.liquidityToken) || r(!1)
        var a,
          c = o.currency.sortsBefore(u.currency) ? [o, u] : [u, o]
        if (((c[0].currency.equals(this.token0) && c[1].currency.equals(this.token1)) || r(!1), e.equal(t.quotient, s)))
          a = e.subtract(n.sqrt(e.multiply(c[0].quotient, c[1].quotient)), i)
        else {
          var p = e.divide(e.multiply(c[0].quotient, t.quotient), this.reserve0.quotient),
            l = e.divide(e.multiply(c[1].quotient, t.quotient), this.reserve1.quotient)
          a = e.lessThanOrEqual(p, l) ? p : l
        }
        if (!e.greaterThan(a, s)) throw new x()
        return n.CurrencyAmount.fromRawAmount(this.liquidityToken, a)
      }),
      (o.getLiquidityValue = function(t, o, u, i, a) {
        var p
        if (
          (void 0 === i && (i = !1),
          ...
          if (e.equal(l, s)) p = o
            ...
            var h = n.sqrt(e.multiply(this.reserve0.quotient, this.reserve1.quotient)),
              f = n.sqrt(l)
            if (e.greaterThan(h, f)) {
              var m = e.multiply(o.quotient, e.subtract(h, f)),
                d = e.add(e.multiply(h, c), f),
                y = e.divide(m, d)
              p = o.add(n.CurrencyAmount.fromRawAmount(this.liquidityToken, y))
            } else p = o
          }
        } else p = o
        return n.CurrencyAmount.fromRawAmount(
          t,
          e.divide(e.multiply(u.quotient, this.reserveOf(t).quotient), p.quotient)
        )
      }),
      f(t, [
        {
  ...
  E = (function() {
    function t(t, e, n) {
      ...
      for (var i, s = [u], a = g(t.entries()); !(i = a()).done; ) {
        var c = i.value,
          p = c[1],
          l = s[c[0]]
        l.equals(p.token0) || l.equals(p.token1) || r(!1)
        var h = l.equals(p.token0) ? p.token1 : p.token0
        s.push(h)
      }
      ...
      f(t, [
        {
          ...
          get: function() {
            ...
            for (var t, e = [], r = g(this.pairs.entries()); !(t = r()).done; ) {
              var o = t.value,
                u = o[1]
              e.push(
...
var _ = (function() {
  ...
  return (
    ...
    (e.maximumAmountIn = function(t) {
      ...
      var e = new n.Fraction(a).add(t).multiply(this.inputAmount.quotient).quotient
      return n.CurrencyAmount.fromRawAmount(this.inputAmount.currency, e)
    }),
    (t.bestTradeExactIn = function(e, o, u, i, a, c, p) {
      var l = void 0 === i ? {} : i,
        h = l.maxNumResults,
        f = void 0 === h ? 3 : h,
        m = l.maxHops,
      ...
      void 0 === a && (a = []),
        ...
        d > 0 || r(!1),
        o === c || a.length > 0 || r(!1)
      for (var y = c.wrapped, v = u.wrapped, T = 0; T < e.length; T++) {
        var A = e[T]
        if (
          (A.token0.equals(y.currency) || A.token1.equals(y.currency)) &&
          !A.reserve0.equalTo(s) &&
          !A.reserve1.equalTo(s)
        ) {
          var q = void 0
          try {
            q = A.getOutputAmount(y)[0]
          } catch (t) {
            if (t.isInsufficientInputAmountError) continue
            throw t
          }
          if (q.currency.equals(v))
            n.sortedInsert(p, new t(new E([].concat(a, [A]), o.currency, u), o, n.TradeType.EXACT_INPUT), f, C)
          else if (d > 1 && e.length > 1) {
            var k = e.slice(0, T).concat(e.slice(T + 1, e.length))
            t.bestTradeExactIn(k, o, u, { maxNumResults: f, maxHops: d - 1 }, [].concat(a, [A]), q, p)
          }
        }
      }
      return p
    ...
    (t.bestTradeExactOut = function(e, o, u, i, a, c, p) {
      var l = void 0 === i ? {} : i,
        h = l.maxNumResults,
        f = void 0 === h ? 3 : h,
        m = l.maxHops,
      ...
      void 0 === a && (a = []),
        ...
        d > 0 || r(!1),
        u === c || a.length > 0 || r(!1)
      for (var y = c.wrapped, v = o.wrapped, T = 0; T < e.length; T++) {
        var A = e[T]
        if (
          (A.token0.equals(y.currency) || A.token1.equals(y.currency)) &&
          !A.reserve0.equalTo(s) &&
          ...
          var q = void 0
          try {
            q = A.getInputAmount(y)[0]
          } catch (t) {
            if (t.isInsufficientReservesError) continue
            throw t
          }
          if (q.currency.equals(v))
            n.sortedInsert(p, new t(new E([A].concat(a), o, u.currency), u, n.TradeType.EXACT_OUTPUT), f, C)
          else if (d > 1 && e.length > 1) {
            var k = e.slice(0, T).concat(e.slice(T + 1, e.length))
            t.bestTradeExactOut(k, o, u, { maxNumResults: f, maxHops: d - 1 }, [A].concat(a), q, p)
          }
        }
      }
      return p
  ...
  return (
    (t.swapCallParameters = function(t, e) {
      ...
      var i,
        s,
        a,
        c = n.validateAndParseAddress(e.recipient),
        p = R(t.maximumAmountIn(e.allowedSlippage)),
        l = R(t.minimumAmountOut(e.allowedSlippage)),
        h = t.route.path.map(function(t) {
          return t.address
        }),
        f =
          'ttl' in e
      ...
      switch (t.tradeType) {
        ...
        case n.TradeType.EXACT_OUTPUT:
          m && r(!1),
            o
              ? ((i = 'swapETHForExactTokens'), (s = [l, h, c, f]), (a = p))
              : u
              ? ((i = 'swapTokensForExactETH'), (s = [l, p, h, c, f]), (a = '0x0'))
              : ((i = 'swapTokensForExactTokens'), (s = [l, p, h, c, f]), (a = '0x0'))
      }
...
;(exports.FACTORY_ADDRESS = '0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f'),
  (exports.INIT_CODE_HASH = '0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f'),
  (exports.InsufficientInputAmountError = x),
  (exports.InsufficientReservesError = I),
  (exports.MINIMUM_LIQUIDITY = i),
  (exports.Pair = b),
  (exports.Route = E),
  (exports.Router = F),
  (exports.Trade = _),
  (exports.computePairAddress = O),
  (exports.inputOutputComparator = P),
  (exports.tradeComparator = C)
